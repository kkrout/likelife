...
(()=>{
    const nodeList = [];
    const ctx = '@@clickothersideContext';

    let startClick;
    let seed = 0;

    !Vue.prototype.$isServer && $(document).on('mousedown', e => (startClick = e));

    !Vue.prototype.$isServer && $(document).on('mouseup', e => {
